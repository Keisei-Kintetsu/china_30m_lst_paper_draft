...
The record covers 2000–2024 and contains 25 annual composites, each organized into 91 regular 4° tiles. This repository provides the current Chinese-language review draft of the *Scientific Data* Data Descriptor, its bibliography, and the nine main publication figures.

该数据记录覆盖2000–2024年，包含25期年度复合产品，每期由91个规则4°瓦片组成。本仓库提供 *Scientific Data* Data Descriptor 的当前中文审阅稿、参考文献、9张正文图及编译后的 PDF。
...
本仓库仅包含论文稿件与发表图件，不包含30 m栅格数据、验证源数据、访问凭据、服务器配置或中间处理文件。
